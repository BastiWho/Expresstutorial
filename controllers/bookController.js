...
exports.book_delete_post = asyncHandler(async (req, res, next) => {
  ...
  // Book has associated authors. Render in the same way as for GET route.
  if (book.authors && book.authors.length > 0) {
    ...
    // Book has no associated authors. Delete the book object and redirect to the list of books.
